...
struct PostDetailView: View {
    ...
    // ファボされていたらドキュメントIDを取得し、格納する
    @Binding var favDocumentID: String
    @Binding var bookmarkDocumentID: String
...
//    @ObservedObject var postData = PostData()
    ...
    static var previews: some View {
        ...
        PostDetailView(selectedPost:
                       ...
                       favDocumentID: .constant("dummy"),
                       bookmarkDocumentID: .constant("dummy")
        )
